...
namespace Common
{
    ...
    public static class AssetBundleManager
    {
        ...
        /// </summary>
        public static AssetBundleLoader Loader => AssetBundleLoader.Instance;
        ...
        /// <param name="startPath">AB 包根目录路径</param>
        /// <returns></returns>
        internal static bool TryResolveBundlePath(string path, out string startName, out string bundleName, out string startPath)
        {
            startName = null;
            bundleName = null;
            startPath = null;
